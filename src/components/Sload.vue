<template>
    <div>
        <shead>
            ...
            <template v-slot:center>下载</template>
        </shead>
        <div class="load">
            <div class="img">
...
export default {
    ...
    methods:{
        tiao(){
            location.href = 'http://acj4.pc6.com/pc6_soure/2019-8/me.ele_372.apk';
        }
    }
}
</script>
